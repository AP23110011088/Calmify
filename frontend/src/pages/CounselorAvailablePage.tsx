...
import { Clock, User, MessageCircle, AlertTriangle, Brain } from 'lucide-react';
...
const CounselorAvailablePage: React.FC = () => {
    ...
    <Layout>
      <div className="container mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-6">
          <div>
            <h1 className="text-3xl font-bold">Available Counselor Sessions</h1>
            <p className="text-gray-600">Provide professional counseling support</p>
          </div>
          ...
          <Card>
            <CardContent className="text-center py-12">
              ...
              <p className="text-gray-600">
                There are currently no counseling sessions waiting for professional helpers.
              </p>
            </CardContent>
          </Card>
        ) : (
...
export default CounselorAvailablePage;